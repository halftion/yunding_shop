...
public interface GoodsMapper {
     ...
     * @return 商品结果列表
     */
    List<Goods> selectByNameSortBySales(String name);
     ...
     * @return 指定平台分类中商品集合
     */
    List<Goods> selectByPlatformCategoryIdSortBySales(int categoryId);
     ...
     * @return 店铺分类中的商品集合
     */
    List<Goods> selectByShopCategoryIdSortBySales(@Param("shopId") int shopId, @Param("categoryId") int categoryId);
     ...
     * @return 商品名称列表
     */
    List<String> selectNameByKeywordSortBySales(String goodsName);
     ...
     * @return 对应的商品列表
     */
    List<Goods> selectByShopIdAndGoodsNameSortBySales(@Param("shopId") Integer shopId, @Param("goodsName") String goodsName);
